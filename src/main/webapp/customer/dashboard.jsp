...
<%
    ...
    for (Object obj : myBookings) {
        com.gajur.marriagehallbookingsystem.model.Booking b = (com.gajur.marriagehallbookingsystem.model.Booking) obj;
        switch (b.getStatus()) {
...
<div class="dashboard-layout">
    ...
    <div class="main-content">
        ...
        <!-- Tabs -->
        <div class="tab-bar">
            <button class="tab-btn active" onclick="switchTab(event,'tab-halls')">🏛️ Browse &amp; Book Halls</button>
            <button class="tab-btn"        onclick="switchTab(event,'tab-bookings')">📋 My Bookings</button>
        </div>
                        ...
                        <div class="hall-book-card">
                            ...
                            <div class="hall-info">
                                ...
                                <div style="display:flex;justify-content:space-between;align-items:center;margin-top:8px;">
                                    ...
                                    <span class="hall-cap">👥 ${hall.seatingCapacity}</span>
                                </div>
                            </div>
                    ...
                    <c:otherwise>
                        ...
                        <div class="booking-row">
                            <div class="booking-icon
                                ...
                                <c:choose>
                                    <c:when test="${b.status=='APPROVED'}">✅</c:when>
                                    <c:when test="${b.status=='PENDING'}">⏳</c:when>
                                    <c:when test="${b.status=='CANCELLED'}">❌</c:when>
                            ...
                            <div class="booking-info">
                                ...
                                <div class="b-date">
                                    📅 <fmt:formatDate value="${b.eventDate}" pattern="dd MMM yyyy"/>
                                    &nbsp;·&nbsp; ${b.eventType}
                                    &nbsp;·&nbsp; 👥 ${b.guestCount} guests
    ...
    <div class="modal-box">
        ...
        <form action="${pageContext.request.contextPath}/BookingServlet" method="post" id="bookingForm">
            ...
            <div style="background:#fff3cd;border-radius:8px;padding:10px 14px;margin-bottom:16px;font-size:0.82rem;color:#856404;">
                ⚠️ Booking will be <strong>PENDING</strong> until approved by the hall owner / admin.
            </div>
