    ...
    <div style="display:grid;grid-template-columns:1fr 380px;gap:24px;">
        ...
        <div style="align-self:start;">
            <div class="info-panel">
                ...
                <div style="background:linear-gradient(135deg,var(--accent),#ead5c0);border-radius:10px;height:120px;display:flex;align-items:center;justify-content:center;font-size:3.5rem;margin-bottom:16px;">
