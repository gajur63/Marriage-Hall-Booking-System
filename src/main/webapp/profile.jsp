...
<div class="dashboard-layout">
    ...
    <div class="main-content">
        ...
        <c:if test="${not empty param.error}">
            <div class="alert alert-danger"><i class="fa-solid fa-triangle-exclamation" style="color: rgb(0, 0, 0);"></i>
                ️ ${param.error}</div>
        </c:if>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
            <!-- Profile Info -->
            <div class="form-card">
                <h3 style="margin-bottom:20px;color:var(--primary);"><i class="fa-solid fa-user"></i> Personal Information</h3>
            ...
            <!-- Change Password -->
            <div class="form-card">
                <h3 style="margin-bottom:20px;color:var(--primary);"><i class="fa-solid fa-lock"></i> Change Password</h3>
                <form action="${pageContext.request.contextPath}/ProfileServlet" method="post">
