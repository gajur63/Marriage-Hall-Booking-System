...
<head><meta charset="UTF-8"><title>Edit Hall - Admin</title>
...
<div class="main-content">
    <div class="page-header">
        <h1>Edit Hall</h1>
        <a href="${pageContext.request.contextPath}/HallServlet?action=adminList" class="btn btn-outline">← Back</a>
    </div>
        ...
        <form action="${pageContext.request.contextPath}/HallServlet" method="post">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="hallName" value="${hall.hallName}" required>
                </div>
                <div class="form-group">
                    <label>City *</label>
                    <input type="text" name="city" value="${hall.city}" required>
                </div>
            </div>
            <div class="form-group">
                <label>Full Address / Location *</label>
                <input type="text" name="location" value="${hall.location}" required>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>Seating Capacity *</label>
                    <input type="number" name="seatingCapacity" value="${hall.seatingCapacity}" required min="10">
                </div>
                <div class="form-group">
                    <label>Price Per Day (NPR) *</label>
                    <input type="number" name="pricePerDay" value="${hall.pricePerDay}" required step="0.01">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>Contact Number</label>
                    <input type="text" name="contactNumber" value="${hall.contactNumber}">
                </div>
                <div class="form-group">
                    <label>Status</label>
                    <select name="status">
                        ...
                        <option value="PENDING" ${hall.status=='PENDING'?'selected':''}>Pending</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <label>Facilities</label>
                <input type="text" name="facilities" value="${hall.facilities}">
            </div>
            <div class="form-group">
                <label>Image URL</label>
                <input type="text" name="imageUrl" value="${hall.imageUrl}">
            </div>
            <div class="form-group">
