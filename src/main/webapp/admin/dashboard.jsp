    ...
    <div class="main-content">
        <div class="page-header">
            <div>
                ...
                <div class="breadcrumb">Welcome back, ${user.fullName}!</div>
            </div>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-icon icon-secondary">💰</div>
                <div class="stat-info">
                    <div class="stat-value" style="font-size:1.2rem;">NPR <fmt:formatNumber value="${revenue}" pattern="#,##0"/></div>
        ...
        <div style="display:flex;gap:12px;margin-bottom:24px;flex-wrap:wrap;">
            <a href="${pageContext.request.contextPath}/HallServlet?action=addForm" class="btn btn-primary">➕ Add Hall</a>
            <a href="${pageContext.request.contextPath}/AdminServlet?action=addOwnerForm" class="btn btn-secondary">➕ Add Owner</a>
            <a href="${pageContext.request.contextPath}/BookingServlet?action=adminList" class="btn btn-outline">📋 All Bookings</a>
            <a href="${pageContext.request.contextPath}/AdminServlet?action=users" class="btn btn-outline">👥 Manage Users</a>
        </div>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <a href="${pageContext.request.contextPath}/BookingServlet?action=adminList" class="btn btn-outline btn-sm">View All</a>
            </div>
            <table>
                <thead>
                    <tr><th>#</th><th>Customer</th><th>Hall</th><th>Event Date</th><th>Amount</th><th>Status</th><th>Action</th></tr>
                </thead>
                <tbody>
