...
<head>
    <meta charset="UTF-8"><title>All Bookings - Admin</title>
...
<div class="page-shell">
    ...
    <c:if test="${not empty param.msg}"><div class="alert alert-success"><i class="fa-solid fa-check" style="color: rgb(39, 49, 46);"></i> ${param.msg}</div></c:if>
