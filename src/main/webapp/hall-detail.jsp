    ...
    <div class="hall-detail-grid">
        ...
        <div>
            <div class="hall-detail-hero">
                <div style="font-size:5rem;text-align:center;margin-bottom:15px;">🏛️</div>
                <h1 style="font-size:1.8rem;font-weight:800;color:var(--primary);">${hall.hallName}</h1>
                <p style="color:var(--gray);margin-top:5px;">📌 ${hall.location}, ${hall.city}</p>
                <p style="color:var(--gray);">📞 ${hall.contactNumber}</p>
                <p style="color:var(--gray);">🏢 Managed by ${hall.ownerName}</p>
            </div>
            ...
            <div class="info-panel">
                ...
                <c:choose>
                    ...
                    <c:when test="${sessionScope.user.role == 'CUSTOMER' && hall.status == 'AVAILABLE'}">
                        <a href="${pageContext.request.contextPath}/BookingServlet?action=bookForm&hallId=${hall.hallId}" class="btn btn-primary w-100 btn-lg" style="margin-top:16px;">📅 Book This Hall</a>
                    </c:when>
...
<footer><p>© 2026 MarriageHall Booking System. Made with <span>♥</span> for your special day.</p></footer>
</body>
</html>
