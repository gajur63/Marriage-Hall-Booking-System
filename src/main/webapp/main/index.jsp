...
<section class="hero">
    <div class="hero-content">
        <h1>Find Your Perfect<br>Wedding Venue <i class="fa-solid fa-ring"></i></h1>
...
<div class="search-section">
    <form action="${pageContext.request.contextPath}/HallServlet" method="get" class="search-form">
        ...
        <div class="form-group">
            <label>&nbsp;</label>
            <button type="submit" class="btn btn-primary w-100"><i class="fa-solid fa-magnifying-glass" style="color: rgb(255, 255, 255);"></i> Search</button>
        </div>
    </form>
</div>
</div>
...
<section class="section">
    <div class="container">
        ...
        <div class="halls-grid">
            ...
            <div class="card hall-card">
                <div class="card-img"><img src="${pageContext.request.contextPath}/${hall.imageUrl}"
                                           alt="Hall Image"></div>
                <div class="card-body">
                    <span class="location-tag"><i class="fa-solid fa-map-pin"></i> ${hall.city}</span>
 ...
 ${hall.seatingCapacity} guests</span>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:24px;margin-top:30px;">
            <div style="text-align:center;padding:20px;">
                <div style="font-size:2.5rem;margin-bottom:10px;"><i class="fa-solid fa-magnifying-glass" style="color: rgb(99, 230, 190);"></i></div>
            ...
            <div style="text-align:center;padding:20px;">
                <div style="font-size:2.5rem;margin-bottom:10px;"><i class="fa-regular fa-calendar" style="color: rgb(99, 230, 190);"></i></div>
            ...
            <div style="text-align:center;padding:20px;">
                <div style="font-size:2.5rem;margin-bottom:10px;"><i class="fa-solid fa-check" style="color: rgb(99, 230, 190);"></i></div>
            ...
            <div style="text-align:center;padding:20px;">
                <div style="font-size:2.5rem;margin-bottom:10px;"><i class="fa-solid fa-shield" style="color: rgb(99, 230, 190);"></i>️</div>
...
<footer>
    <p>© 2026 MarriageHall Booking System. Made with <span><i class="fa-solid fa-heart"></i></span> for your special day.</p>
</footer>
</body>
</html>
