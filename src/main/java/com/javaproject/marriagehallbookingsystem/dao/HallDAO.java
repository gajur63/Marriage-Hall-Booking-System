package com.javaproject.marriagehallbookingsystem.dao;

import com.javaproject.marriagehallbookingsystem.model.Hall;
import com.javaproject.marriagehallbookingsystem.util.DBConnection;
...
public class HallDAO {
    ...
    public boolean updateHall(Hall hall) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            ps.setString(9, hall.getImageUrl());
            ps.setString(10, hall.getStatus());
            ps.setInt(11, hall.getHallId());
